...
<script>
  ...
  if (lazyHash(SecondAnswer) == 8246957399872469000)
    {setCookie("loc4_SecondAnswerCookie", SecondAnswer, 365); LoadAll();} 
  else if (lazyHash(PreviousSecondAnswer) == 8246957399872469000)
    {LoadAll();}
  ...
  function LoadAll(){
    ...
    document.getElementById("DecodedMessage").innerHTML = A_Decode("YHtbgbgbqzumtbp4##44");
  }
