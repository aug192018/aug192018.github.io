...
<script>
  ...
  if (lazyHash(SecondAnswer) == 8246959407606339000)
    {setCookie("loc3_SecondAnswerCookie", SecondAnswer, 365); LoadAll();} 
  else if (lazyHash(PreviousSecondAnswer) == 8246959407606339000)
    {LoadAll();}
  ...
  function LoadAll(){
    ...
    document.getElementById("DecodedMessage").innerHTML = A_Decode("YHtbgbgbqzumtbp4##33");
  }
