...
<script>
  ...
  if (lazyHash(SecondAnswer) == 8245356102421490000)
    {setCookie("loc1_SecondAnswerCookie", SecondAnswer, 365); LoadAll();} 
  else if (lazyHash(PreviousSecondAnswer) == 8245356102421490000)
    {LoadAll();}
  ...
  function LoadAll(){
    ...
    document.getElementById("DecodedMessage").innerHTML = A_Decode("YHtbgbgbqzumtbp4##22");
  }
